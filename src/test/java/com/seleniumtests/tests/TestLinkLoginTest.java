...
public class TestLinkLoginTest extends SeleniumTestPlan {
    ...
    //	user.setUserID("elastictest2");
    	...
    	DriveLoginPage tlp= new DriveLoginPage("dropbox");
    	/*DriveLoginPage tlp1= new DriveLoginPage("box");
    	DriveLoginPage tlp2= new DriveLoginPage("dropbox");
    	DriveLoginPage tlp3= new DriveLoginPage("gdrive");*/
    	tlp.loginToDrive(user);
    	//ap.verifyDocumentationDropDown();
    	
    /*	TestLinkLoginPage tlp= new TestLinkLoginPage(true);
  ...
  //  @Test(groups = {"testForFailure"}, dataProvider = "loginData", description = "This test is bound to fail")
     ...
     * @throws  Exception
     */
   // @Test(groups = {"testsSkippedMethod"}, dataProvider = "loginData", description = "This test is also bound to fail",
